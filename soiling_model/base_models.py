...
class helios:
    ...
    def export_SolarPILOT(self, time, f, file_SF, sim_data):
        ...
        shutil.copy(file_SF, file_SF[:file_SF.rfind(".")] + "_new" + file_SF[file_SF.rfind("."):])  # questo crea una copia uguale
        df['Soiling factor'] = soiling_factor_helios

        df.to_csv(file_SF[:file_SF.rfind(".")] + "_new" + file_SF[file_SF.rfind("."):], index=False, na_rep='NULL')

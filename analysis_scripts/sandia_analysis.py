...
sp_save_file = f"{main_directory}/results/sp_fitting_results_sandia"
cm_save_file = f"{main_directory}/results/cm_fitting_results_sandia"
figure_format = ".pdf"
...
parameter_file = d+"parameters_sandia_experiments.xlsx"
...
# November 2025 (remove initial errors/mistakes and last day after weekend rain(?))
all_intervals[0][0] = np.datetime64('2025-11-05T15:30:00')
all_intervals[0][1] = np.datetime64('2025-11-14T16:15:00')
...
_,_,_ = imodel.plot_soiling_factor( sim_data_train,
                            ...
                            save_path=f"{main_directory}/results/sandia_semi_physical_training",
...
_,_,_ = imodel_constant.plot_soiling_factor(    sim_data_train,
                                                ...
                                                save_path=f"{main_directory}/results/sandia_constant_mean_training",
...
for ii,experiment in enumerate(sim_data_total.dt.keys()):
    fig,ax = smu.plot_experiment_data(sim_data_total,reflect_data_total,ii,lgd_size = 10)
...
fig.savefig(f"{main_directory}/results/losses_sandia.pdf",dpi=300,bbox_inches='tight',pad_inches=0)

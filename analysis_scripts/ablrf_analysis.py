...
sp_save_file = f"{main_directory}/results/sp_fitting_results_ablrf"
cm_save_file = f"{main_directory}/results/cm_fitting_results_ablrf"
figure_format = ".pdf"
...
parameter_file = d+"parameters_ablrf_experiments.xlsx"
...
_,_,_ = imodel.plot_soiling_factor( sim_data_train,
                            ...
                            save_path=f"{main_directory}/results/ablrf_semi_physical_training",
...
_,_,_ = imodel_constant.plot_soiling_factor(    sim_data_train,
                                                ...
                                                save_path=f"{main_directory}/results/ablrf_constant_mean_training",
...
fig.savefig(f"{main_directory}/results/losses_ablrf.pdf",dpi=300,bbox_inches='tight',pad_inches=0)
